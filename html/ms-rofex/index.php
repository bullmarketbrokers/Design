...
<html lang="en">
  <head>
    ...
    <title>Invertir en rofex, aprendé a comprar y operar rofex | BMB</title>
    <meta name="keywords" content="Operar en Rofex"/>
    <meta name="description" content="Aprendé todo sobre Rofex y obtené el mejor retorno, Te mostramos la mejores formas de invertir en Rofex!"/>    
  ...
  <body>
    ...
    <div class="top">
        <div class="container">
        	<h1 class="slogan">Invertir en rofex, aprendé a comprar y operar rofex</h1>
			<h2 class="main-title">Operar en Rofex</h2>
	...
	<div class="section">
    	<div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <a class="recItem" href="http://www.blanqueocapitales.com.ar" target="_blank">
                    	<h4>Blanqueo de Capitales</h4>
                    	<img src="images/ad-blanqueo.jpg" alt="Blanqueo">
                        <p>Todo lo que querías saber sobre el Blanqueo de Capitales y cómo aprovecharlo. Informate sobre cómo blanquear a un menor costo y al mismo tiempo, invertir en un bono líquido con un muy buen retorno en dólares</p>
                    </a>
                </div>                     
            </div>
        </div>
